...
from resources import SBERT_resource, qdrant_client_resource
...
defs = Definitions(
    ...
    resources={
        "SBERT": ResourceDefinition.hardcoded_resource(SBERT_resource),
        "qdrant": ResourceDefinition.hardcoded_resource(qdrant_client_resource),
    }
)